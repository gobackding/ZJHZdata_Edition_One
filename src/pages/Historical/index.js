...
class Historical extends React.Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <div style={{ background: 'rgb(244, 244, 244)', padding: '30px' }}>
                    <Row gutter={16}>
                ...
                <div style={{ backgroundColor: '#fff' }}>
                    <div style={{ padding: '10px 30px', marginBottom: '10px' }}>
                        <Button type="primary" style={{ marginRight: '30px' }}>查看详情</Button>
    ...
    async componentDidMount() {
        ...
        let FromList = this.props.CheckingUpCharts.jhjglsList
        if (this.props.CheckingUpCharts == 0) {
            ...
            console.log(Array)
            let totleRuleCount = this.props.FromListStatus.length
            let JCSJZLSum = this.props.CheckingUpCharts.jhjglsList[0].JCSJZLSum
            let SFSJZLSum = this.props.CheckingUpCharts.jhjglsList[0].SFSJZLSum
            let bili = this.props.CheckingUpCharts.jhjglsList[0].bili
            this.setState({
    ...
    async HandlerTableValue(val) {
        ...
        console.log(ListValueApi, 'ListValueApi')
